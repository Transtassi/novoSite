...
class RoutesController extends Controller
{
  ...
  // Função para mostrar a pagina SERVIÇOS/SOLUÇÔES SEGMENTADAS
  public function services()
  {
    return view('pages.services');
  }

  // Função para mostrar a pagina SERVIÇOS/TassiLog
  public function TassiLog()
  {
    return view('pages.tassilog');
  }

  // Função para mostrar a pagina SERVIÇOS/Carga Dedicada
  public function dedicatedCargo()
  {
    return view('pages.dedicatedcargo');
  }

  // Função para mostrar a pagina Blog
  public function blog()
  {
    $blogs = $this->objBlog->orderBy('id','desc')->get();
